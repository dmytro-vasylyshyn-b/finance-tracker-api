package com.vasylyshyn.finanseTracker.Components;

import com.vasylyshyn.finanseTracker.Entitys.Users;
import com.vasylyshyn.finanseTracker.Services.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (user.isPresent() && jwtService.isTokenValid(jwt, Optional.of(user.get()))) {
                Users authUser = user.get();
